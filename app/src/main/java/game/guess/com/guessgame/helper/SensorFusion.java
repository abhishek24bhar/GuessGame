...
public class SensorFusion extends Service
    ...
    Intent intent;
    int flag;
    static final public String BROADCAST_ACTION = "com.abhishek.broadcast2";
    ...
    public void updateOreintationDisplay() {
        //Log.e("Result",""+"called");
       // Log.e("Result",""+Double.parseDouble(d.format(fusedOrientation[2] * 180/Math.PI)));
...
*/
    ...
    public void sendResult(int flag) {
        intent.putExtra("sensorval", flag);
